...
\begin{center}
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        \begin{axis}[
            xlabel={Distance to Bulb (cm)},
            ylabel={Hydrometer Calibration Mark},
            ymin=0, ymax=20,
            xmin=9.95, xmax=10.35,
            ytick={5,10,15,20},
            xtick={9.95, 10.05,  10.15,  10.25, 10.35},
            xticklabels={0.995, 1.005,1.015, 1.025, 1.035},
            ymajorgrids=true,
            grid style=dashed,
            legend pos = north east,
            legend cell align={left},
        ]
        \addplot[only marks, red] table [x=x1_mod, y=y1] {8.csv};
        \addplot[only marks, blue] table [x=x2_mod, y=y2] {8.csv};
        \addlegendentry{$H_r$};
        \addlegendentry{$H_r'$};
        \addplot[dashed, blue, domain=9.95:10.35] {-262*(x/10)+279.73};
        \addplot[dashed, red, domain=9.95:10.35] {-262*(x/10)+278.51};
        \end{axis}
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 2: Hydrometer Calibration Graph}
    \emph{\\Figure 2: Hydrometer Calibration Graph}
\end{center}
\newpage
...
\begin{center}  
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        ...
        \addplot[dashed, red, domain=20:49] {-5.341*ln(x)+45.715};
        \addlegendentry{$x=25$ blows}
        
        \end{axis}
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 3: Flow Index}
...
\begin{center}  
    \begin{tabular}{|l|r|} 
        ...
        \hline
        \textbf{Minimum Density (lb/ft$\bm{^3}$)}   & 80.92       \\ 
        \hline
        \textbf{Dry Unit Weight at 75\% Relative Density (g)}  & 110.7       \\ 
        \hline
        \textbf{Moisture Content at 75\%}          & 14.6\%       \\ 
        \hline
    ...
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        ...
        \addplot[only marks, blue] table [x=x, y=dry] {3.csv}; \label{d_u_w}
        \addplot[only marks, green] table [x=x, y=wet] {3.csv}; \label{w_u_w}
        \addplot[only marks, orange] table [x=x, y=100] {3.csv}; \label{t_d_w}
        \addplot[only marks, purple] table [x=x, y=80] {3.csv}; \label{t_d_w_80}
        \addplot +[only marks, black, mark options={fill=black}] coordinates {(8.55, 104.85)}; \label{o}
        ...
        \begin{axis}[
          ...
          \addlegendimage{/pgfplots/refstyle=d_u_w}\addlegendentry{Dry Unit Weight};
          \addlegendimage{/pgfplots/refstyle=w_u_w}\addlegendentry{Wet Unit Weight};
          \addlegendimage{/pgfplots/refstyle=t_d_w}\addlegendentry{Theoretical Dry Unit Weight at $S=100$};
          \addlegendimage{/pgfplots/refstyle=t_d_w_80}\addlegendentry{Theoretical Dry Unit Weight at $S=80$};
          \addlegendimage{/pgfplots/refstyle=o}\addlegendentry{Optimum Moisture Content and Maximum Density};
          \addplot[red, domain=8:39] {0.0158*x^2-0.2708*x+39.239};
        \end{axis}
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 4: Standard Proctor Test Results}
    \emph{\\Figure 4: Standard Proctor Test Results\\}
    \vspace{5mm}
    \pgfplotsset{width=10cm}
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        \begin{axis}[
        ...
        \addplot[only marks, blue] table [x=x, y=y] {4_og.csv};
        \addplot[only marks, red] table [x=x, y=y] {4.csv};
        \addplot[dashed, red, domain=0:0.3] {-10363*x^2+4260.4*x};
        \addplot[dashed, blue, domain=0:0.3] {-1036.3*x^2+426.04*x};

        \addlegendentry{Original Division};
        \addlegendentry{$\times10$};
        \end{axis}
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 5: First Determination}
    \emph{\\Figure 5: First Determination\\}
    \vspace{5mm}
    \pgfplotsset{width=10cm}
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        \begin{axis}[
        ...
        \addplot[only marks, blue] table [x=x,y=y] {5_og.csv};
        \addplot[only marks, red] table [x=x, y=y] {5.csv};
        \addplot[dashed, red, domain=0:0.5] {-1121.1*x^2+1489.9*x};
        \addplot[dashed, blue, domain=0:0.5] {-210.26*x^3+30.857*x^2+129.81*x};
        \addplot[only marks, green, mark options={fill=green}] coordinates {(0.1, 150.5471)};
        \addplot[dashed, green, domain=0:0.1] {1800*x-30};
        \addplot[only marks, green, mark options={fill=green}] coordinates {(0.1, 150.5471/10)};
        \addplot[dashed, green, domain=0:0.1] {(1800*x-30)/10};
    ...
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 6: Second Determination}
    \emph{\\Figure 6: Second Determination\\}
    \vspace{5mm}
    \pgfplotsset{width=10cm}
    \begin{tikzpicture}[baseline=(current bounding box.center)]
        \begin{axis}[
        ...
        \addplot[only marks, blue] table [x=x,y=y] {6_og.csv};
        \addplot[only marks, red] table [x=x, y=y] {6.csv};
        \addplot[dashed, red, domain=0:0.5] {-105.61*x^3+74.587*x^2+21.964*x};
        \addplot[dashed, blue, domain=0:0.5] {-9.9716*x^3+7.1648*x^2+2.258*x};
        \addplot[only marks, green, mark options={fill=green}] coordinates {(0.1, 2.771916147)};
        \addplot[dashed, green, domain=0:0.1] {40.571*x-1.2171};
        \addplot[only marks, green, mark options={fill=green}] coordinates {(0.1, 0.277191615)};
        \addplot[dashed, green, domain=0:0.1] {(40.571*x-1.2171)/10};
        \addlegendentry{Original Division};
        \addlegendentry{$\times10$};
    ...
    \end{tikzpicture}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 7: Third Determination}
...
\begin{figure}[!htb]
    ...
    \begin{minipage}{0.45\textwidth}
        \begin{tikzpicture}[baseline=(current bounding box.center)]
            ...
            \addplot[only marks, red] table [x=w, y=cbr] {10.csv};
            \addplot[only marks, blue] table [x=w, y=soaked] {10.csv};
            \addplot[dashed, red, domain=0:30] {0.009*x^2-2.0514*x+48.345};
            \addplot[dashed, blue, domain=0:30] {0.006*x^2-1.3676*x+32.23};
            \addlegendentry{CBR};
            \addlegendentry{Soaked CBR};
            \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \begin{tikzpicture}[baseline=(current bounding box.center)]
            ...
            \addplot[only marks, green] table [x=w, y=cbr] {10_og.csv};
            \addplot[only marks, orange] table [x=w, y=soaked] {10_og.csv};
            \addplot[dashed, green, domain=0:30] {0.0006*x^2-0.195*x+4.7702};
            \addplot[dashed, orange, domain=0:30] {0.0004*x^2-0.13*x+3.1801};
            \addlegendentry{CBR};
            \addlegendentry{Soaked CBR};
            \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \vspace{3mm}
    \addcontentsline{lof}{figure}{Figure 8: CBR and Soaked CBR vs. Moisture Content}
    \emph{\\Figure 8: CBR and Soaked CBR vs. Moisture Content}
\end{figure}
...
\begin{center}
    ...
    \end{tabular}
    \vspace{3mm}
    \addcontentsline{lot}{table}{Table 6: AASHTO and USCS Descriptions}
...
\begin{center}
    ...
    \end{tabular}
    \vspace{3mm}
    \addcontentsline{lot}{table}{Table 7: FAA Description}
...
\addcontentsline{lof}{figure}{Figure 9: FAA Classification Table}
\emph{\\Figure 9: FAA Classification Table\\}
\vspace{5mm}
\includegraphics*[scale=0.5]{fig2.png}
\addcontentsline{lof}{figure}{Figure 10: Plasticity Chart}
\emph{\\Figure 10: Plasticity Chart\\}
\vspace{10mm}
\includegraphics*[scale=0.5]{fig3.png}
\addcontentsline{lof}{figure}{Figure 11: AASHTO Classification Table}
\emph{\\Figure 11: AASHTO Classification Table\\}
\includegraphics*[scale=0.8]{fig4.png}
\addcontentsline{lof}{figure}{Figure 12: USCS Classification Table}
\emph{\\Figure 12: USCS Classification Table\\}
\includegraphics*[scale=0.7]{fig5.png}
\addcontentsline{lof}{figure}{Figure 13: Flow Chart for Group Names}
\emph{\\Figure 13: Flow Chart for Group Names\\}
\includegraphics*[scale=0.8]{fig6.png}
\addcontentsline{lof}{figure}{Figure 14: Flow Chart for Group Names of Inorganic Silty and Clayey Soils}
